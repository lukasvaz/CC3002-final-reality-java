...
class initTurnTest {
 ...
 @Test
 void action() throws InvalidWeaponAssignmentException, WeaponNotInInventoryException, NullWeaponException, InterruptedException {
  ...
  Thread.sleep(e.getWeight()*100+1000);//e.weight+1 seg
  //test state change
